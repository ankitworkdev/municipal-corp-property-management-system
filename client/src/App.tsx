    ...
    <AuthProvider>
      <Routes>
        ...
        <Route path="/eo" element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
          ...
          <Route path="citizen-role" element={<DataPage title="Citizens" api="/users/citizens" columns={[{key:"name",h:"Citizen",type:"avatar",nameKeys:["firstName","lastName"]},{key:"mobile",h:"Mobile"},{key:"status",h:"Status",badge:true}]} rowLink="/eo/users" />} />
          <Route path="official-role" element={<DataPage title="Officials" api="/users/officials" columns={[{key:"name",h:"Official",type:"avatar",nameKeys:["firstName","lastName"]},{key:"role",h:"Role"},{key:"email",h:"Email"},{key:"status",h:"Status",badge:true}]} addFields={[{key:"firstName",label:"First Name"},{key:"lastName",label:"Last Name"},{key:"email",label:"Email"},{key:"mobile",label:"Mobile"},{key:"role",label:"Role",type:"select",options:[{v:"EO",l:"Executive Officer"},{v:"HC",l:"Head Clerk"},{v:"TI",l:"Tax Inspector"},{v:"GO",l:"Grievance Officer"}]},{key:"password",label:"Password"}]} />} />
          <Route path="staffs" element={<DataPage title="Staff" api="/staffs" columns={[{key:"name",h:"Staff",type:"avatar"},{key:"email",h:"Email"},{key:"role",h:"Role"},{key:"assignedWards",h:"Wards"}]} />} />
          ...
          <Route path="website-content/officers-profile" element={<DataPage title="Officers" api="/website-content/officers-profile" columns={[{key:"name",h:"Officer",type:"avatar",nameKeys:["name"],avatarImageKeys:["photoUrl"]},{key:"designation",h:"Designation"},{key:"mobile",h:"Mobile"}]} addFields={[{key:"name",label:"Name"},{key:"designation",label:"Designation"},{key:"mobile",label:"Mobile"},{key:"email",label:"Email"},{key:"photoUrl",label:"Photo",type:"file",uploadFolder:"officers"}]} />} />
