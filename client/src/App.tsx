    ...
    <AuthProvider>
      <Routes>
        ...
        <Route path="/eo" element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
          ...
          <Route path="properties" element={<DataPage title="Properties" api="/properties" entityPreviewType="PROPERTY" columns={[{key:"propertyId",h:"Property",type:"entityThumb"},{key:"propertyType",h:"Type"},{key:"ownerName",h:"Owner"},{key:"mobile",h:"Mobile"},{key:"verificationStatus",h:"Status",badge:true}]} rowLink="/eo/properties" />} />
