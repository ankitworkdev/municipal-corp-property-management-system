    ...
    <AuthProvider>
      <Routes>
        ...
        <Route path="/eo" element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
          ...
          <Route path="website-content/contents" element={<DataPage title="Website Content" api="/website-content/contents" columns={[{key:"purpose",h:"Purpose"},{key:"title",h:"Title"},{key:"description",h:"Desc"}]} addFields={[{key:"purpose",label:"Purpose",type:"select",options:[{v:"GALLERY",l:"Gallery"},{v:"ANNOUNCEMENT",l:"Announcement"},{v:"NOTICE",l:"Notice"}]},{key:"title",label:"Title"},{key:"description",label:"Description"}]} />} />
          ...
          <Route path="website-content/officers-profile" element={<DataPage title="Officers" api="/website-content/officers-profile" columns={[{key:"name",h:"Name"},{key:"designation",h:"Designation"}]} addFields={[{key:"name",label:"Name"},{key:"designation",label:"Designation"},{key:"mobile",label:"Mobile"}]} />} />
        </Route>
