    ...
    <AuthProvider>
      <Routes>
        ...
        <Route path="/eo" element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
          ...
          <Route path="citizen-role" element={<DataPage title="Citizens" api="/users/citizens" subtitle="Click a row or Profile & photo to edit details and upload a profile picture (admin can upload on behalf of any citizen)." columns={[{key:"name",h:"Citizen",type:"avatar",nameKeys:["firstName","lastName"]},{key:"mobile",h:"Mobile"},{key:"status",h:"Status",badge:true}]} rowLink="/eo/users" />} />
          <Route path="official-role" element={<DataPage title="Officials" api="/users/officials" subtitle="Login accounts for officers (EO, HC, TI, GO). Use Profile & photo to upload or change their profile picture as admin." columns={[{key:"name",h:"Official",type:"avatar",nameKeys:["firstName","lastName"]},{key:"role",h:"Role"},{key:"email",h:"Email"},{key:"status",h:"Status",badge:true}]} rowLink="/eo/users" addFields={[{key:"firstName",label:"First Name"},{key:"lastName",label:"Last Name"},{key:"email",label:"Email"},{key:"mobile",label:"Mobile"},{key:"role",label:"Role",type:"select",options:[{v:"EO",l:"Executive Officer"},{v:"HC",l:"Head Clerk"},{v:"TI",l:"Tax Inspector"},{v:"GO",l:"Grievance Officer"}]},{key:"password",label:"Password"},{key:"profilePhotoUrl",label:"Profile photo",type:"file",uploadFolder:"users",accept:"image/jpeg,image/png,image/webp"}]} />} />
          <Route path="staffs" element={<DataPage title="Staff" api="/staffs" subtitle="Staff are linked to user accounts. Photos come from each person's profile — click Profile & photo (or the row) to upload as admin." columns={[{key:"name",h:"Staff",type:"avatar"},{key:"email",h:"Email"},{key:"role",h:"Role"},{key:"assignedWards",h:"Wards"}]} rowLink="/eo/users" rowLinkIdKey="userId" />} />
          <Route path="properties" element={<DataPage title="Properties" api="/properties" entityPreviewType="PROPERTY" columns={[{key:"propertyId",h:"Property",type:"entityThumb"},{key:"propertyType",h:"Type"},{key:"ownerName",h:"Owner",type:"avatar",nameKeys:["ownerName"],avatarImageKeys:["owner.profilePhotoThumbUrl","owner.profilePhotoUrl"]},{key:"mobile",h:"Mobile"},{key:"verificationStatus",h:"Status",badge:true}]} rowLink="/eo/properties" />} />
          ...
          <Route path="website-content/officers-profile" element={<DataPage title="Website officers" api="/website-content/officers-profile" subtitle="Public website profiles only (shown on the citizen homepage). This is separate from Staff/Officials login accounts — upload the photo here for the website." columns={[{key:"name",h:"Officer",type:"avatar",nameKeys:["name"],avatarImageKeys:["photoUrl"]},{key:"designation",h:"Designation"},{key:"mobile",h:"Mobile"}]} addFields={[{key:"name",label:"Name"},{key:"designation",label:"Designation"},{key:"mobile",label:"Mobile"},{key:"email",label:"Email"},{key:"photoUrl",label:"Photo",type:"file",uploadFolder:"officers"}]} />} />
